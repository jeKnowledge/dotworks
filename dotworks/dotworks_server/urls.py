...
urlpatterns = [
    ...
    url(r'^edit_profile/(?P<student_id>[0-9]+)/$', views.edit_profile, name='edit_profile'),
    ...
    url(r'^inscription_removal/(?P<inscription_id_>[0-9]+)/$', views.inscription_removal, name='inscription_removal'),
